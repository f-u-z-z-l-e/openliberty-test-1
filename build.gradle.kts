...
//    providedCompile("io.openliberty.features:microProfile-3.2:19.0.0.12")
    providedCompile("io.openliberty.features:cdi-2.0:19.0.0.12")
    providedCompile("io.openliberty.features:ejbLite-3.2:19.0.0.12")
    providedCompile("io.openliberty.features:jsonb-1.0:19.0.0.12")
